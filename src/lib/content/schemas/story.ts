...
/** Full achievement schema is an explicit open point in docs/concept.md §9 — kept minimal/provisional. */
...
/** story/story.json (docs/concept.md §5.3, §5.6) */
export const storySchema = z.object({
	castBindings: z.array(castBindingSchema),
	achievements: z.array(achievementSchema).default([]),
	delayedEvents: z.array(delayedEventSchema).default([]),
	// §6: manifest/story may optionally declare which player-profile fields it needs.
