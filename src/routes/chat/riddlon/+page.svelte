...
<div class="flex h-dvh flex-col bg-surface">
	...
	<div class="flex flex-1 flex-col gap-1 overflow-y-auto px-4.5 pt-4.5 pb-2.5">
		<div
		...
		>
			...
			<div class="mt-2.5 text-label leading-relaxed text-slate-500">{t('library.importNote')}</div>
		</div>
	...
	<div class="flex-none border-t border-line bg-surface px-3.5 pt-[11px] pb-[22px]">
		<ChipRow {chips} />
	</div>
</div>
